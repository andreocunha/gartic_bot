...
def screenshot():
    ...
    try:
        ...
        print("Erro na imagem copiada, tente copiar e dar 'b' novamente")
        restarApp()
    beep(1000)
...
def iniciarPrograma():
    ...
    if os.path.exists('configs.log'):
        ...
        print("Por ipsbruno\n\nwww.brunodasilva.com\n\n\n=========================\nCopie seu desenho para área de trabalho usando Lightshot e aperta 'b' para desenhar\nPara reiniciar ou parar o desenho pressione 'i'\n\n1:Enquanto estiver desenhando não mexa o mouse\n2:O desenho é feito  onde o cursor do mouse estava quando você deu 'b'")
        while not keyboard.is_pressed("b") and not keyboard.is_pressed("i"):
            pass
